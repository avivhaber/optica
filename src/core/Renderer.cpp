...
Renderer::Renderer(int width, int height, float fov, float focalLength, int samplesPerPixel, int maxDepth)
: camera(Camera(width, height, fov, focalLength)), samplesPerPixel(samplesPerPixel), maxDepth(maxDepth) {}
